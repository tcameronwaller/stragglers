...
# last draft of script: TCW; ___ 2022
...
# Define paths.
name_file_identifier="210421_id_matching_gwas.csv"
...
path_directory_persistence="${path_directory_storage}/phenotypes/mayo_clinic_bipolar_disorder_access_2022-08-31"
